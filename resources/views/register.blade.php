...
<!-- Mirrored from dompet.dexignlab.com/flask/demo/page-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Jun 2024 04:39:23 GMT -->
<head>
   <!-- All Meta -->
	<meta charset="utf-8">
	...
	<meta name="description" content="Dompet is a clean-coded, responsive Flask template that can be easily customised to fit the needs of various credit card and invoice, modern, creative, Transfer money, and other businesses.">
	<meta property="og:title" content="Dompet - Payment Flask Admin Dashboard Bootstrap Template">
	<meta property="og:description" content="Dompet is a clean-coded, responsive Flask template that can be easily customised to fit the needs of various credit card and invoice, modern, creative, Transfer money, and other businesses.">
					...
					<div class="login-form">
						...
						<form action="#">
							...
							<div class="form-row d-flex justify-content-between mt-4 mb-2">
								...
								<div class="mb-4">
									<a href="{{url('/')}}" class="btn-link text-primary">Sign in</a>
								</div>
							</div>
							...
							<p class="text-center">Not registered?  
								<a class="btn-link text-primary" href="https://dompet.dexignlab.com/xhtml/page-error-404.html">Register</a>
							</p>
						</form>
					</div>
				</div>
...
<!-- Mirrored from dompet.dexignlab.com/flask/demo/page-register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 29 Jun 2024 04:39:24 GMT -->
</html>